...
{
    public interface ICareIdentityService
    {
        ...
        ValueTask CallbackAsync(string code, string state, CancellationToken cancellationToken = default);
        ValueTask<string> GetAccessTokenAsync(CancellationToken cancellationToken = default);
        ValueTask<NhsUserInfo> GetUserInfoAsync(string accessToken, CancellationToken cancellationToken = default);
    }
}
